"""
run-convert-54b-15min.py
Run athena-convert-54b-15min.py on a set of 54B csv historical files in the old format
...
print('\nConverting old TA54B 15 min history files to a new format:\n')
for oldHistFile in oldHistFiles:
    newHistFile = NEW_HIST_DIR + '/' + oldHistFile
    print(oldHistFile, '->', newHistFile)
    command = ['python3', 'athena-convert-54b-15min.py', oldHistFile, newHistFile]
