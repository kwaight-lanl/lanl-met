#!/usr/bin/env python3
"""
athena-convert-54b-15min.py
Read an old historical csv file of 15 min data for TA54B and run
  the conversion program to read it and rewrite the data in a
  new historical format.
To run: python3 athena-convert-54b-15min.py old-hist-file new-hist-file
